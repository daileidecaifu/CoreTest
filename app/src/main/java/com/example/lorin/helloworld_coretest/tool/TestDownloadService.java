...
import com.example.lorin.helloworld_coretest.MainActivity;
...
//                    Uri uri = Uri.fromFile(new File(APK_dir));
                    ...
                    PendingIntent mPendingIntent = PendingIntent.getActivity(TestDownloadService.this, 0, installIntent, 0);
