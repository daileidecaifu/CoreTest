...
public class CrashDBManager {
     ...
     * add CrashMarkManual
     *
     * @param crashMarkManual
     */
    public void add(CrashMarkManual crashMarkManual) {
        db.beginTransaction();  //开始事务
        try {
            db.execSQL("INSERT INTO crash VALUES(null, ?, ?, ?)", new Object[]{crashMarkManual.getCurrence_time(), crashMarkManual.getCrash_message(), crashMarkManual.getHas_sent()});
