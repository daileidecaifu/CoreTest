...
public class SQLStatement implements Serializable {
   ...
   */
  public long execInsert(SQLiteDatabase db, Object entity)
  ...
  public int execInsertCollectionWithMapping(SQLiteDatabase db, Collection<?> list,
   ...
   * 执行更新单个数据，返回受影响的行数
   */
  public int execUpdateWithMapping(SQLiteDatabase db, Object entity, TableManager tableManager)
      throws IOException {
    printSQL();
    mStatement = db.compileStatement(sql);
    if (!Checker.isEmpty(bindArgs)) {
  ...
  /**
   * 执行删操作.(excute delete ...)，返回受影响的行数 并将关系映射删除
   */
  public int execDeleteWithMapping(final SQLiteDatabase db, Object entity,
      TableManager tableManager)
      throws IOException {
    printSQL();
    mStatement = db.compileStatement(sql);
   ...
   * 执行删操作.(excute delete ...)，返回受影响的行数 并将关系映射删除
   */
  public int execDeleteCollectionWithMapping(final SQLiteDatabase db,
  ...
  public String toString() {
    return "SQLStatement [sql=" + sql + ", bindArgs=" + Arrays.toString(bindArgs) + ", mStatement="
        + mStatement
        + "]";
  }
  /*------------------------------ 私有方法 ------------------------------*/
